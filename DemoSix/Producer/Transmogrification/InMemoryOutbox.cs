...
public record Entry(string Topic, string Key, Message<string, TransmogrificationSettings> Value, PersistenceStatus Status, Partition Partition, Timestamp Timestamp) { }

public interface IOutbox
{
    void Add(string topic, string key, Message<string, TransmogrificationSettings> value);
...
public class InMemoryOutbox : IOutbox
{
    ...
    public void Add(string topic, string key, Message<string, TransmogrificationSettings> value)
    {
